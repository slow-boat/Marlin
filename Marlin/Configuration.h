...
#define X_BED_SIZE 234 /* x axis endstop microswitch hole rheemed out to allow it to slide across a few mm */
...
#define PREHEAT_1_FAN_SPEED   255 // PLA Value from 0 to 255
